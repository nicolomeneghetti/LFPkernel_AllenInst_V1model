...
def compute_utils_from_bmtk_to_population(target_population: str, target_node_id: int, simulation_length: int, dt_simulation: float, zaxis_rotation: float, num_levels:int):
    ...
    spikes_tables = pd.read_pickle('./Allen_Inst_V1_model_features/L23_flashes/spike_L23_flashes.pkl')
    spikes_tables_LGN = pd.read_pickle('./Allen_Inst_V1_model_features/L23_flashes/spike_lgn_flashes.pkl')
    spikes_tables_BKG = pd.read_pickle('./Allen_Inst_V1_model_features/L23_flashes/spike_bkg_flashes.pkl')
    spikes_tables_FB = pd.read_pickle('./Allen_Inst_V1_model_features/L23_flashes/spike_fb_flashes.pkl')
...
def compute_LFP_bmtk_to_population_fromV1(target_population, target_query_node_type_id, zaxis_rotation, num_levels):
    ...
    simulation_length = 7 # seconds of simulations when V1 was presented with flashes
