...
def compute_utils_from_bmtk_to_population(target_population: str, target_node_id: int, simulation_length: int, dt_simulation: float, zaxis_rotation: float, num_levels:int):
    ...
    somatic_positions = load_dataframe('./Allen_Inst_V1_model_features/posizione_somatiche.pkl')
    ...
    spikes_tables = pd.read_pickle('./Allen_Inst_V1_model_features/L23_spiking_gratings/spike_fullcolumn_L23_gratings.pkl')
    spikes_tables_LGN = pd.read_pickle('./Allen_Inst_V1_model_features/L23_spiking_gratings/spike_lgn_gratings.pkl')
    spikes_tables_BKG = pd.read_pickle('./Allen_Inst_V1_model_features/L23_spiking_gratings/spike_bkg_gratings.pkl')
    spikes_tables_FB = pd.read_pickle('./Allen_Inst_V1_model_features/L23_spiking_gratings/spike_fb_gratings.pkl')
