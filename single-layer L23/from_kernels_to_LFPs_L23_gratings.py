...
spikes_tables_V1 = pd.read_pickle('./Allen_Inst_V1_model_features/only_L23_spiking_gratings/spike_only_L23_gratings.pkl')
...
def main():
    ...
    # Load vector levels
    vector_levels_path = './gratings_kernels/vector_time_normalized_levels'
    ...
    for target in TARGET_VECTOR:
        folder = './gratings_kernels/' #the folder in which the kernels are stored
...
for ind1 in ['487661754']: #the target ID of the e23Cux2 family in the single-layer L23 model
    ...
    lfp_path = f"./from kernels to LFPs/gratings/LFPs_Allen_Inst_single_layer_e23Cux2.p"
